...
WebUI.setText(findTestObject('Page_CURA Healthcare Service/txtUsername_username'), 'John Doe')

WebUI.setEncryptedText(findTestObject('Page_CURA Healthcare Service/txtPassword_password'), 'g3/DOGG74jC3Flrr3yH+3D/yKbOqqUNM')
